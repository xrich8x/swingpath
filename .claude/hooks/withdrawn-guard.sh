...
#   has not worked / Traps) and a COPY of it lives on in the mutable "Open" table,
...
# old number.
LIVE="CLAUDE.md SCOREBOARD.md ML_PRACTICES.md ML_PLAYBOOK.md README.md USER_GUIDE.md SETUP_PROMPT.md PM_REVIEW_PROMPT.md"

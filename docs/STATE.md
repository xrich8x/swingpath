...
| **`gate_ball_to_court` is NOT dead code on the gold caches** | Measured 2026-08-29 while establishing H-routing: it removes locks on **4 of 7** calibrated gold clips - gold_sAjkpeRq4P4 **-674**, gold_uR5q2cSM6AY -43, gold_L73ep7JHiJ4 -30, yt_match40 -5 - and is a no-op only on am_hard_utr, yt_rally2, gold_UHf0LeMU2pg. The "0 locks removed, 14/14" result was measured on the detector-A/B caches and does not generalise. It still runs BEFORE the smoother, so smoother A/B deltas stay H-clean. | [evidence/bounce-hypothesis-v2-gate.md](evidence/bounce-hypothesis-v2-gate.md) |

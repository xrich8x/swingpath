...
| **P0-3 crop-around-contact - PROVISIONAL, awaiting human review of the contact sheets** | A human to read `data/output/p0_3_sheet_yt_match40_crop192at640_x.png`. Rebuilt with a homography-free population and a person-specific test: full frame @1280 finds the far player at **0 of 25** far-end contacts on `yt_match40`, a 192px native crop fed at 640 at **15 of 25**. The variable is the **upscale factor** (peak ~100-140 px of player in the tensor), not the crop size. `am_hard_utr` (n=12) is UNDERPOWERED and its population is contaminated | [evidence/p0-3-crop-around-contact.md](evidence/p0-3-crop-around-contact.md) |

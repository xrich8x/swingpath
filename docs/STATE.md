...
| **The ball-chain stopping rule is now live** | **A decision, not a measurement.** The gate was pre-registered 2026-08-26 and the first mechanism run against it FAILED on 2026-08-27 at **4.50:1 against >7** - but that ratio rests on a **denominator of 2 ghost frames**, so the stopping rule should not be applied mechanically. The cheap decisive follow-up is more no-ball frames, not another mechanism. | [evidence/ball-chain-gate.md](evidence/ball-chain-gate.md) |

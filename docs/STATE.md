...
| **Ball-chain gate PRE-REGISTERED 2026-08-26, before any code** | Nothing. Written and ready. Six bars on all three calibrated clips, including a **separation** bar (>7 real frames per ghost added) that a threshold move cannot pass by construction, plus a stopping rule. | [evidence/ball-chain-gate.md](evidence/ball-chain-gate.md) |
